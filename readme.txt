...
For example this script can run the first 20 username/password requests using a list of credentials, pause the script for 10 minutes, then carry on with the script from where it left off for the next 20 requests, pause for 10 minutes, run the next 20 requests etc. until the whole list of credentials has been tried.
